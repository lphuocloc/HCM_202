      ...
      <div className="flex-1 flex items-center justify-center px-4 py-8 md:py-12">
        ...
        {slide.isVideoSlide && slide.video ? (
          <div className="w-full max-w-5xl">
            ...
            <p className="text-center text-amber-600 font-serif mt-6 text-lg">
              {slide.title}
            </p>
          </div>
        ) : (
          <div
            className={`w-full max-w-4xl transition-all duration-500 ${isAnimating
              ? direction === 'next'
      ...
      <footer className="border-t border-amber-200/50 px-6 py-5">
        <div className="max-w-4xl mx-auto flex justify-between items-center">
          ...
          <button
            ...
            className={`flex items-center gap-2 font-serif transition-all ${currentSlide === 0
          ...
          <button
            ...
            className={`flex items-center gap-2 font-serif transition-all ${currentSlide === totalSlides - 1
              ? 'text-amber-300 cursor-not-allowed'
              : 'text-amber-700 hover:text-amber-900'
              }`}
          >
